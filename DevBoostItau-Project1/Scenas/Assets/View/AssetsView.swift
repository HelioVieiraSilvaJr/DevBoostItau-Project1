...
class AssetsView: BaseView{
    ...
    override func installConstraints() {
        ...
        balncelabel.topAnchor.constraint(equalTo: myBelongslabel.bottomAnchor, constant: 3.5).isActive = true
        balncelabel.leadingAnchor.constraint(equalTo: myBelongslabel.leadingAnchor).isActive = true

        
        seeBalanceButton.centerYAnchor.constraint(equalTo: balncelabel.centerYAnchor).isActive = true
        ...
        seeBalanceButton.leadingAnchor.constraint(equalTo: balncelabel.trailingAnchor, constant: 5).isActive = true

        
        tableView.topAnchor.constraint(equalTo: balncelabel.bottomAnchor, constant: 20).isActive = true
